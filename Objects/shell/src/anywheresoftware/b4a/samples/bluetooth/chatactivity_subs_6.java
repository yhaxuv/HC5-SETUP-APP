...
public class chatactivity_subs_6 {
...
chatactivity.mostCurrent._label3.runMethod(true,"setText",RemoteObject.createImmutable(("OK")));
 ...
 BA.debugLineNum = 40;BA.debugLine="Label2.Text= Buffer(5)";
Debug.ShouldStop(128);
chatactivity.mostCurrent._label2.runMethod(true,"setText",(_buffer.getArrayElement(true,BA.numberCast(int.class, 5))));
 }};
