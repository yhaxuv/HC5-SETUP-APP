...
public class chatactivity_subs_10 {
...
_logmessage(BA.ObjectToString("You"),chatactivity.mostCurrent.__c.runMethod(true,"BytesToString",(Object)(_buffer),(Object)(BA.numberCast(int.class, 0)),(Object)(_buffer.getField(true,"length")),(Object)(RemoteObject.createImmutable("UTF8"))));
 BA.debugLineNum = 34;BA.debugLine="If Buffer(0)=\"2\" Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",_buffer.getArrayElement(true,BA.numberCast(int.class, 0)),BA.numberCast(double.class, "2"))) { 
...
{ BA.debugLineNum = 37;BA.debugLine="else if Buffer(0)=\"3\" Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("=",_buffer.getArrayElement(true,BA.numberCast(int.class, 0)),BA.numberCast(double.class, "3"))) { 
...
chatactivity.mostCurrent._label3.runMethod(true,"setText",RemoteObject.createImmutable(("OK")));
 ...
 BA.debugLineNum = 40;BA.debugLine="txtInput.Text= Buffer(5)";
Debug.ShouldStop(128);
chatactivity.mostCurrent._txtinput.runMethodAndSync(true,"setText",(_buffer.getArrayElement(true,BA.numberCast(int.class, 5))));
 }};
