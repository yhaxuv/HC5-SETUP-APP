...
try {
		Debug.PushSubsStack("Activity_Create (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,19);
...
chatactivity.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("2")),chatactivity.mostCurrent.activityBA);
 BA.debugLineNum = 21;BA.debugLine="If AStream.IsInitialized = False Then";
...
if (RemoteObject.solveBoolean("=",chatactivity._astream.runMethod(true,"IsInitialized"),chatactivity.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 22;BA.debugLine="AStream.InitializePrefix(Main.serial1.InputStrea";
...
try {
		Debug.PushSubsStack("Activity_Pause (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,45);
...
if (_userclosed.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 47;BA.debugLine="AStream.Close";
...
try {
		Debug.PushSubsStack("Activity_Resume (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,41);
...
try {
		Debug.PushSubsStack("AStream_Error (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,31);
if (RapidSub.canDelegate("astream_error")) return chatactivity.remoteMe.runUserSub(false, "chatactivity","astream_error");
 BA.debugLineNum = 31;BA.debugLine="Sub AStream_Error";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 32;BA.debugLine="ToastMessageShow(\"Connection is broken.\", True)";
...
try {
		Debug.PushSubsStack("AStream_NewData (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,27);
...
Debug.locals.put("Buffer", _buffer);
 BA.debugLineNum = 27;BA.debugLine="Sub AStream_NewData (Buffer() As Byte)";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 28;BA.debugLine="LogMessage(\"You\", BytesToString(Buffer, 0, Buffer";
...
try {
		Debug.PushSubsStack("AStream_Terminated (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,37);
if (RapidSub.canDelegate("astream_terminated")) return chatactivity.remoteMe.runUserSub(false, "chatactivity","astream_terminated");
 BA.debugLineNum = 37;BA.debugLine="Sub AStream_Terminated";
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="AStream_Error";
Debug.ShouldStop(32);
_astream_error();
...
try {
		Debug.PushSubsStack("btnSend_Click (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,63);
if (RapidSub.canDelegate("btnsend_click")) return chatactivity.remoteMe.runUserSub(false, "chatactivity","btnsend_click");
 BA.debugLineNum = 63;BA.debugLine="Sub btnSend_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 64;BA.debugLine="AStream.Write(txtInput.Text.GetBytes(\"UTF8\"))";
Debug.ShouldStop(-2147483648);
chatactivity._astream.runVoidMethod ("Write",(Object)(chatactivity.mostCurrent._txtinput.runMethod(true,"getText").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 65;BA.debugLine="txtInput.SelectAll";
Debug.ShouldStop(1);
chatactivity.mostCurrent._txtinput.runVoidMethod ("SelectAll");
 BA.debugLineNum = 66;BA.debugLine="txtInput.RequestFocus";
Debug.ShouldStop(2);
chatactivity.mostCurrent._txtinput.runVoidMethod ("RequestFocus");
 BA.debugLineNum = 67;BA.debugLine="LogMessage(\"Me\", txtInput.Text)";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("LogMessage (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,70);
...
Debug.locals.put("Msg", _msg);
 BA.debugLineNum = 70;BA.debugLine="Sub LogMessage(From As String, Msg As String)";
Debug.ShouldStop(32);
 BA.debugLineNum = 71;BA.debugLine="txtLog.Text = txtLog.Text & From & \": \" & Msg & C";
Debug.ShouldStop(64);
chatactivity.mostCurrent._txtlog.runMethodAndSync(true,"setText",(RemoteObject.concat(chatactivity.mostCurrent._txtlog.runMethod(true,"getText"),_from,RemoteObject.createImmutable(": "),_msg,chatactivity.mostCurrent.__c.getField(true,"CRLF"))));
 BA.debugLineNum = 72;BA.debugLine="txtLog.SelectionStart = txtLog.Text.Length";
...
try {
		Debug.PushSubsStack("Setup_click (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,55);
if (RapidSub.canDelegate("setup_click")) return chatactivity.remoteMe.runUserSub(false, "chatactivity","setup_click");
 BA.debugLineNum = 55;BA.debugLine="Sub Setup_click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 56;BA.debugLine="txtInput.Text=\"setup id:\" & id.text";
Debug.ShouldStop(8388608);
chatactivity.mostCurrent._txtinput.runMethodAndSync(true,"setText",(RemoteObject.concat(RemoteObject.createImmutable("setup id:"),chatactivity.mostCurrent._id.runMethod(true,"getText"))));
 BA.debugLineNum = 57;BA.debugLine="AStream.Write(txtInput.Text.GetBytes(\"UTF8\"))";
Debug.ShouldStop(16777216);
chatactivity._astream.runVoidMethod ("Write",(Object)(chatactivity.mostCurrent._txtinput.runMethod(true,"getText").runMethod(false,"getBytes",(Object)(RemoteObject.createImmutable("UTF8")))));
 BA.debugLineNum = 58;BA.debugLine="txtInput.SelectAll";
Debug.ShouldStop(33554432);
chatactivity.mostCurrent._txtinput.runVoidMethod ("SelectAll");
 BA.debugLineNum = 59;BA.debugLine="txtInput.RequestFocus";
Debug.ShouldStop(67108864);
chatactivity.mostCurrent._txtinput.runVoidMethod ("RequestFocus");
 BA.debugLineNum = 60;BA.debugLine="LogMessage(\"Me\", txtInput.Text)";
Debug.ShouldStop(134217728);
_logmessage(BA.ObjectToString("Me"),chatactivity.mostCurrent._txtinput.runMethod(true,"getText"));
...
try {
		Debug.PushSubsStack("txtInput_EnterPressed (chatactivity) ","chatactivity",1,chatactivity.mostCurrent.activityBA,chatactivity.mostCurrent,51);
if (RapidSub.canDelegate("txtinput_enterpressed")) return chatactivity.remoteMe.runUserSub(false, "chatactivity","txtinput_enterpressed");
 BA.debugLineNum = 51;BA.debugLine="Sub txtInput_EnterPressed";
Debug.ShouldStop(262144);
 BA.debugLineNum = 52;BA.debugLine="If btnSend.Enabled = True Then btnSend_Click";
Debug.ShouldStop(524288);
